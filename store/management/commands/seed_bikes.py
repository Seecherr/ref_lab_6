        ...
        regular_bikes = [
            {
                ...
                "price": 18500,
                "description": "Ідеальний міський велосипед для щоденних поїздок. Легка алюмінієва рама, надійні гідравлічні гальма та 21 швидкість для будь-якого рельєфу.",
            },
            {
                ...
                "color": "Синій металік",
                "price": 32000,
                "description": "Професійний гірський велосипед з карбоновою рамою. Створений для серйозних трейлів та складних маршрутів у горах.",
            },
            {
                "name": "SpeedWing Aero",
                "bike_type": "regular",
                ...
                "price": 45000,
                "description": "Шосейний велосипед для швидкісних поїздок та змагань. Аеродинамічна карбонова рама мінімізує опір повітря.",
            },
            {
                ...
                "price": 12500,
                "description": "Класичний круїзер для неспішних прогулянок містом. Комфортна посадка, широке сідло та стильний ретро-дизайн.",
            },
            {
                ...
                "price": 9800,
                "description": "Надійний велосипед для початківців та підлітків. Легка рама, простий у обслуговуванні та дуже витривалий.",
            },
        ]
        ...
        electric_bikes = [
            {
                ...
                "description": "Потужний електровелосипед для будь-яких умов. Мотор 750W забезпечує легкий підйом на круті схили, а ємний акумулятор Samsung — до 80 км на одному заряді.",
            },
            {
                "name": "EcoGlide City",
                "bike_type": "electric",
                ...
                "description": "Елегантний міський електровелосипед з низькою рамою. Ідеальний для щоденних поїздок на роботу та по магазинах.",
            },
            {
                ...
                "description": "Преміальний електричний гірський велосипед з мотором Shimano EP8. Повна підвіска для максимального комфорту на будь-яких трейлах.",
            },
            {
                ...
                "description": "Компактний складний електровелосипед. Ідеальний для мультимодальних поїздок — легко поміщається в багажник авто або громадський транспорт.",
            },
        ]
